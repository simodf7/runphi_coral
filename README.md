...
Then mount the boot partition with:
```bash
mount -t vfat /dev/sda1 /mnt/sd_boot/
```
supposing that /dev/sda1 is the name of the boot partition and /mnt/sd_boot/ is an available path.
