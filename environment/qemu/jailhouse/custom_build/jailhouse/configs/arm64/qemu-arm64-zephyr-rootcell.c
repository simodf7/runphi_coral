...
struct {
	...
	.header = {
		...
		.root_cell = {
			.name = "qemu-arm64-zephyr-rootcell",
	...
	.mem_regions = {
		...
		JAILHOUSE_SHMEM_NET_REGIONS(0x7f900000, 0),
		/* IVSHMEM shared memory regions for 00:02.0 (networking) */
		JAILHOUSE_SHMEM_NET_REGIONS(0x7fa00000, 0),
		/* IVSHMEM shared memory regions for 00:03.0 (networking) */
		//JAILHOUSE_SHMEM_NET_REGIONS(0x7fb00000, 0),
		/* IVSHMEM shared memory regions for 00:04.0 (networking) */
		//JAILHOUSE_SHMEM_NET_REGIONS(0x7fc00000, 0),
		/* MMIO (permissive) */ {
	...
	.pci_devices = {
		...
		/* { // IVSHMEM 0001:00:03.0 (networking)
			.type = JAILHOUSE_PCI_TYPE_IVSHMEM,
			.domain = 1,
			.bdf = 3 << 3,
			.bar_mask = JAILHOUSE_IVSHMEM_BAR_MASK_INTX,
		...
		/*
		{ // IVSHMEM 0001:00:04.0 (networking) 
			.type = JAILHOUSE_PCI_TYPE_IVSHMEM,
			.domain = 1,
			.bdf = 4 << 3,
			.bar_mask = JAILHOUSE_IVSHMEM_BAR_MASK_INTX,
