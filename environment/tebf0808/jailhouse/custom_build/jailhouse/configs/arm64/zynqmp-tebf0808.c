...
struct {
	...
	.header = {
		...
		.hypervisor_memory = {
			.phys_start = 0x6f000000,	/* memoria riservata a jailhouse nel device tree (OK).*/
			.size =       0x01000000,
		},
		.debug_console = {
			.address = 0xff000000,	/* la seriale, uguale a zcu (OK)*/
			.size = 0x1000,
			.type = JAILHOUSE_CON_TYPE_XUARTPS,
			.flags = JAILHOUSE_CON_ACCESS_MMIO |
				 JAILHOUSE_CON_REGDIST_4,
		},
		.platform_info = {	/*forse tutto da capire dai docs*/
			.pci_mmconfig_base = 0xfc000000, /*capire, indirizzo pci */
			...
			.iommu_units = {	/*questo indirizzo nel device tree appartiene alla smmu; probabilmente giusto*/
				{
			...
			.arm = {
				.gic_version = 2,	/*info sul GIC. Da modificare. Nel mio device tree leggermente diverso*/
			...
			.memguard = {	/* non saprei. controllare nella documentazione; probabilmente uguale?*/
			...
			.qos = {	
				.nic_base = 0xfd700000, /*controlalre queste cose nella documentazione*/
				/* 1MiB Aperture */
				.nic_size = 0x100000,
			},
		},
		...
		.root_cell = {
			...
			.vpci_irq_base = 136-32,	/*controllare sempre in base ai pci*/
		},
	},
	...
	.rcpus = {
		0x7, //0x3 /*non le ho? non le stiamo usando*/?
	},
