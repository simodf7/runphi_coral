...
Waar kan ik aptitude vinden?
  ...
  Vanuit de broncode aptitude bouwen
   ...
   openen en de opdracht tar zxf aptitude-0.8.11.tar.gz uitvoeren om de
   broncode uit te pakken. Als dat gebeurd is, typ dan cd aptitude-0.8.11 &&
